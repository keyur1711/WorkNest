    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative w-full px-6 md:px-12 lg:px-16 pt-16 pb-12">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900">About WorkNest</h1>
              <p className="mt-4 text-lg text-gray-600">We are building the most seamless way to discover, compare, and book co-working spaces—so teams can focus on their best work, not logistics.</p>
            </div>
            <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                <div key={s.label} className="group p-6 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className={`w-10 h-10 rounded-lg ${s.bgClass} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}>
        ...
        <section className="w-full px-6 md:px-12 lg:px-16 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">WorkNest exists to make quality workspaces accessible to everyone—from founders and freelancers to fast-growing teams. We bring transparency to availability and pricing, unify communication between users and owners, and streamline the booking experience with secure payments and clear agreements.</p>
              <p className="mt-3 text-gray-600 leading-relaxed">By connecting under-utilized spaces with flexible demand, we help cities run more efficiently while giving teams the choice to work where they produce their best.</p>
            </div>
        ...
        <section className="w-full px-6 md:px-12 lg:px-16 py-12">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={v.title} className="group p-6 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className={`w-12 h-12 rounded-xl ${v.bgClass} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
            ...
            <div className="space-y-6">
              {timeline.map((t, idx) => (
                <div key={t.year} className="relative pl-12 group">
                  ...
                  <div className="p-6 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="text-lg font-semibold text-gray-900">{t.title}</div>
                      <div className="text-xs text-gray-500 font-medium px-2 py-1 rounded-full bg-gray-100">{t.year}</div>
                    </div>
                    <div className="mt-2 text-sm text-gray-600 leading-relaxed">{t.desc}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="w-full px-6 md:px-12 lg:px-16 py-12">
          ...
          <p className="mt-2 text-gray-600">A small team with a big ambition to make work better for everyone.</p>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="group p-6 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="mt-4 font-semibold text-gray-900">{member.name}</div>
