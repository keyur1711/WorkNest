  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 md:px-12 lg:px-16 py-10">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-gray-900">Profile Settings</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {success && (
                  <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-emerald-600">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full h-12 px-4 rounded-lg border-2 border-slate-200 focus:outline-none focus:border-sky-400"
                  />
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
              ...
              <Link
                to="/dashboard"
                className="block px-4 py-3 rounded-lg border border-gray-200 hover:border-sky-300 hover:bg-sky-50 transition text-gray-700 font-medium"
              >
                Dashboard
              </Link>
              <Link
